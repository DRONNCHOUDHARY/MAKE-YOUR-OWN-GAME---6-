...
function preload(){
    ...
    enemy1Group = loadImage("Sprites/Zombieleft.png");
    enemy2Group = loadImage("Sprites/Zombieright.png");
    enemy3Group = loadImage("Sprites/Zombieup.png");
    enemy4Group = loadImage("Sprites/Zombiedown.png");
}
